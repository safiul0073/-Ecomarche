                ...
                <div class="card-body">
                    <form method="POST" enctype="multipart/form-data" action="{{!empty($user) ? route('user.update',$user->id) : route('user.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" value="{{!empty($user) ? $user->name : ''}}" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <input type="submit" class="btn btn-primary" value="{{empty($user) ? "Register" : "Update"}}">
