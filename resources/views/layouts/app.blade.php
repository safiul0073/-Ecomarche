...
<head>
    ...
    <link href="C:\xampp\htdocs\EcommarchDeshboard\resources\views\layouts\style.css" rel="stylesheet">
    ...
    <link rel="stylesheet" href="{{ asset('css/sidebarMain.css')}}">
